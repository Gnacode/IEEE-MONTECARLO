#!/usr/bin/env python3
"""
TSNFA Monte Carlo Simulator (Deliverable 2)
============================================
...
class RawDataSnapshot:
    ...
    def to_dict(self) -> Dict:
        ...
        trigger_keys = ['triggers_proposed', 'triggers_lipski', 'triggers_cacfar',
...
def plot_comparison(results_by_size: Dict[int, Dict],
    ...
    ALL_METHODS = ['proposed', 'lipski', 'cacfar', 'oscfar', 'cusum']
    METHOD_LABELS = {
        'proposed': 'TSNFA',  'lipski':   'Lipski',   'cacfar':   'CA-CFAR',
...
def main():
    ...
    log.info(f"  TSNFA (proposed): γ_d={GAMMA_D}, γ_a={GAMMA_A}, ζ={ZETA}")
